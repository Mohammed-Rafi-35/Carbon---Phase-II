...
from app.api.v1.routes.workers import router as workers_router
...
REQUEST_COUNTER = Counter("identity_http_requests_total", "Total API requests", ["method", "path"])
REQUEST_LATENCY = Histogram("identity_http_request_seconds", "Latency of API requests", ["method", "path"])
