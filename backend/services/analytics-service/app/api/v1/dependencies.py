...
def get_current_subject(payload: dict = Depends(get_token_payload)) -> str:
...
def get_rate_limiter_key(request: Request, subject: str = Depends(get_current_subject)) -> str:
