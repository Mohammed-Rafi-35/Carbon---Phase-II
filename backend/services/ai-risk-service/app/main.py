...
REQUEST_COUNTER = Counter("ai_risk_http_requests_total", "Total API requests", ["method", "path"])
REQUEST_LATENCY = Histogram("ai_risk_http_request_seconds", "Latency of API requests", ["method", "path"])
