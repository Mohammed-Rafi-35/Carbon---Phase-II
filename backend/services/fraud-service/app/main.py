...
from app.events.consumer import FraudEventConsumer
from app.models import fraud_check  # noqa: F401
from app.utils.logging import configure_logging
from app.utils.request_id import RequestIDMiddleware


settings = get_settings()
REQUEST_COUNTER = Counter("fraud_http_requests_total", "Total API requests", ["method", "path"])
REQUEST_LATENCY = Histogram("fraud_http_request_seconds", "Latency of API requests", ["method", "path"])

event_consumer: FraudEventConsumer | None = None
...
async def lifespan(_: FastAPI):
	...
	if settings.enable_event_consumer and settings.app_env != "test":
		event_consumer = FraudEventConsumer()
